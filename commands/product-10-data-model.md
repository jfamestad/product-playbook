...
If missing, **block**: a data model without enumerated access patterns produces fiction. Recommend `/product-9-access-patterns` first.
...
```
YYYY-MM-DD HH:MM PST — /product-10-data-model — ./artifacts/data-model.md
```
...
> Next:
> - `/product-11-prebuild-qa` — answer the 12 pre-build questions before engineering starts.
